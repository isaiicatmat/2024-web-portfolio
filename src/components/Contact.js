...
export default function Contact() {
  return (
    <section className="mt-16 container" id="contact">
      <img className="max-w-xs mx-auto md:max-w-xs" src={Isai} alt="" />
